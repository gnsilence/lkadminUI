...
export default {
  ...
  methods: {
    ...
    async add(node, data) {
      ...
      this.menuloading = true
      var res = await this.$API.system.menu.list.add({
        type: 1,
        name: newMenuData.name,
        code: newMenuData.name,
        pid: newMenuData.parentId,
        openType: 1,
        path: newMenuData.path,
        component: newMenuData.component,
        application: 'system'
      })
      this.menuloading = false
    ...
    async delMenu() {
      ...
      var res = await this.$API.system.menu.list.batchDelete(reqData)
      this.menuloading = false
