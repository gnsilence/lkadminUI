 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-10 09:52:08
 * @Description: file content
 * @FilePath: \front\src\App.vue
-->
<template>
	<el-config-provider class="viewroute" :locale="$i18n.messages[$i18n.locale].el" :button="{autoInsertSpace: false}">
		<router-view ></router-view>
	</el-config-provider>
		<el-backtop target=".viewroute" :visibility-height="100" :bottom="100" :right="20">
    <div
      style="
        height: 100%;
        width: 100%;
