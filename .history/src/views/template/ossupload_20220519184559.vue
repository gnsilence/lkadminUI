...
-->
<template>
	<uploader ref="uploader" :fileStatusText="statusText" @file-added="onFileAdded" @file-success="onFileSuccess" @file-progress="onFileProgress" @file-error="onFileError" :options="options" class="uploader-example">
