<template>
    ...
    <el-container>
      <el-header>
        ...
        <div class="right-panel">
		  ...
		  <el-button @click="clkAddUser" type="primary">新增用户</el-button>
        </div>
      </el-header>
      <el-main class="nopadding">
        <yyTable
  ...
  <addUserDialog v-if="addUserDig.isShow" ref="addUserDialog" @close="addUserDig.isShow=false"></addUserDialog>
</template>
...
export default {
  components: { Search, setRoleDialog,addUserDialog },
  setup() {
	...
	const clkAddUser=()=>{
		addUserDig.value.isShow=true
		nextTick(() => {
			addUserDialog.value.open()
		})
	}
    // 设置角色确定
    const hleSuccess = () => {
