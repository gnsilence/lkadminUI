 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-05 17:52:24
        ...
        <el-table-column label="操作" width="200" align="center">
          <template #default="scope">
            ...
            <el-dropdown>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item command="a" @click="handleCommand('a',scope.row)">启用</el-dropdown-item>
                  <el-dropdown-item command="b" @click="handleCommand('b',scope.row)">停用</el-dropdown-item>
                  <el-dropdown-item
