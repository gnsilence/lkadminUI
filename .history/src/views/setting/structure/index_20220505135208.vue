<template>
    ...
    <el-container>
      <el-header>
        ...
        <div class="right-panel">
		  ...
		  <el-button @click="adduserAndEmp" type="primary">新增用户</el-button>
        </div>
      </el-header>
      <el-main class="nopadding">
        <yyTable
  ...
  <addUser ref="adduserRef" v-if="addUserDig.isShow" @close="addUserDig.isShow=false"></addUser>
</template>
...
export default {
  ...
  nextTick(()=>{
	  console.log('%c⧭', 'color: #0088cc', adduserRef.value)
  })
		// nextTick(()=>{
