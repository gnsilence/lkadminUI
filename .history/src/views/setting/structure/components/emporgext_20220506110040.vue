 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-06 11:00:40
		...
		<div class="mb30">
			...
			<div class="flex justify-space-between mb30" style="padding: 0 15px">
				<div class="flex">
					...
					<div class="fz-14 fw-600">附属机构</div>
				</div>
			...
			<div class="flex justify-space-between align-items productTable">
				<div class="fz-14 wp-260">机构名称</div>
			...
			<el-form ref="formRef" label-width="0px" :model="produceLists" :rules="rules">
				<div class="flex mb15 justify-space-between align-items productTableItem" v-for="(val, index) in produceLists.produce">
					<div class="wp-260">
						<el-form-item :prop="'produce.' + index + '.productValue'" :rules="rules.productValue">
							<el-tree-select class="treeselect" v-model="Empform.orgId" :data="groupTree" clearable />
						</el-form-item>
					</div>
					<div class="wp-150">
						<el-form-item :prop="'produce.' + index + '.price'" :rules="rules.price">
							<el-input v-model="val.price" :controls="false" placeholder="请输入成交金额" style="width: 100%" @changeMoney="priceChnage(index)"></el-input>
						</el-form-item>
					</div>
