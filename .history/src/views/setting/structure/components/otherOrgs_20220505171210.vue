<!--
 * @Author: gongnan
 * @Date: 2022-05-05 17:12:05
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-05 17:12:05
 * @Description: file content
 * @FilePath: \front\src\views\setting\structure\components\otherOrgs.vue
-->
<template>
  <div>
    <div class="mb30">
...
export default {
  name: "ContractProductInfo",
  components: { Plus, MoneyInput },
  setup(props, { emit }) {
