<template>
	<scDialog :title="title" :htitle="htitle" :show-fullscreen="false" :model-value="visible" :destroy-on-close="true" :width="800" :height="800" :loading="loading" @closed="$emit('close')">
