 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-06 11:12:19
				...
				<div class="flex mb15 justify-space-between align-items productTableItem" v-for="(val, index) in emporgLists.emp">
					...
					<div class="wp-150">
						<el-form-item :prop="'produce.' + index + '.price'" :rules="rules.price">
							<el-select v-model="val.PosId" filterable :multiple-limit="5" clearable multiple placeholder="请选择岗位" style="width:100%" @clear="clearSelect" @change="chgSelect">
