 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-09 15:54:14
				...
				<div class="flex mb15 justify-space-between align-items productTableItem" v-for="(val, index) in emporgLists.emp">
					...
					<div class="wp-150">
						<el-form-item :prop="'emp.' + index + '.PosId'" :rules="rules.price">
							<el-select v-model="val.PosId" filterable clearable placeholder="请选择岗位" style="width:100%" @clear="clearSelect" @change="chgSelect(val,index)">
