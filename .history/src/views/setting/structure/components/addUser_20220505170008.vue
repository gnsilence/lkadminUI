<template>
	<scDialog :title="title" :htitle="htitle" :show-fullscreen="true" :model-value="visible" :destroy-on-close="true" :width="800" :loading="loading" @closed="$emit('close')">
		<el-tabs v-model="tabname">
			<el-tab-pane name="user" label="用户信息">
				<el-form :model="form" :rules="userrules" :disabled="mode=='show'" ref="dialogForm" label-width="100px" label-position="left">
					...
					<template v-if="mode=='add'">
								...
								<el-form-item label="确认密码" prop="confirmpwd">
									<el-input @blur="setPwdValue" type="password" v-model="form.confirm" clearable show-password></el-input>
								</el-form-item>
</template>
							</el-form>
							</el-tab-pane>
				...
				<el-form :model="formemp" :rules="emprules" ref="dialogEmpForm" label-width="100px" label-position="left">
					<el-form-item label="工号" prop="jobNum">
						<el-input v-model="form.jobNum" placeholder="用于登录系统" clearable></el-input>
					</el-form-item>
					 <el-form-item label="所属部门:" prop="limitTime">
						 <!-- <yySelectTree :data='groupTree' keyid='id' :value='Empform.orgId' :label="Empform.orgName" placeholder='请选择所属部门' class="width-100" :loading='treeLoading' @change="chgOrgIds"></yySelectTree> -->
						 <el-tree-select v-model="Empform.orgId" :data="groupTree" />
          </el-form-item>
				</el-form>
			</el-tab-pane>
		</el-tabs>
