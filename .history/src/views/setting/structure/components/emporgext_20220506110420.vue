 ...
 * @LastEditors: gongnan
 * @LastEditTime: 2022-05-06 11:04:20
				...
				<div class="flex mb15 justify-space-between align-items productTableItem" v-for="(val, index) in emporgLists.emp">
					...
					<div class="wp-150">
						<el-form-item :prop="'produce.' + index + '.price'" :rules="rules.price">
							<el-input v-model="val.postname" :controls="false" placeholder="请输入成交金额" style="width: 100%" @changeMoney="priceChnage(index)"></el-input>
						</el-form-item>
					</div>
