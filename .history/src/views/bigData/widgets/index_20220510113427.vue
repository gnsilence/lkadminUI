<template>
	<div style="overflow-x:hidden;overflow-y:hidden" :class="['widgets-home', customizing?'customizing':'']" ref="main">
	...
	export default {
		...
		methods: {
			...
			setLayout(layout){
				...
				if(layout.join(',')=='24,8,8,8'){
					this.grid.copmsList[0] = [...this.grid.copmsList[0]]
					this.grid.copmsList[1] = [...this.grid.copmsList[1]]
					this.grid.copmsList[2] = [...this.grid.copmsList[2]]
					this.grid.copmsList[3] = []
				}
			},
			//追加
